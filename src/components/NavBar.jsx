    ...
    <div ref={navref} className="p-3 ">
      <div className='lol text-center rounded-4xl flex justify-between items-center bg-[#4338CA] py-2.5 px-5 '>
        ...
        <div className='flex gap-5 items-center'>
          ...
          <Link className='border-2  border-[#6366F1] text-[#C7D2FE]    leading-tight px-2.5 py-1.5 rounded-3xl active:scale-95 bg-(--c4) text-base font-medium  font-[regular]' to='/collection'>Collection</Link>
        </div>
      </div>
    </div>
  )
